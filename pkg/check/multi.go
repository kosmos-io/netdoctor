...
var multiCheckExample = templates.Examples(i18n.T(`
...
type CommandMultiCheckOptions struct {
	Namespace          string
...
func NewCmdMultiCheck() *cobra.Command {
	o := &CommandMultiCheckOptions{
...
func (o *CommandMultiCheckOptions) Complete() error {
	if len(o.DstImageRepository) == 0 {
		o.DstImageRepository = o.ImageRepository
	}

	srcFloater := NewMultiFloater(o, false)
	...
	if o.DstKubeConfig != "" {
		dstFloater := NewMultiFloater(o, true)
...
func (o *CommandMultiCheckOptions) Validate() error {
...
func (o *CommandMultiCheckOptions) Run() error {
...
func (o *CommandMultiCheckOptions) RunRange(iPodInfos []*FloatInfo, jPodInfos []*FloatInfo) []*PrintCheckData {
	var resultData []*PrintCheckData
		...
		for _, iPodInfo := range iPodInfos {
			for _, jPodInfo := range jPodInfos {
				for _, ip := range jPodInfo.PodIPs {
					...
					if o.DstFloater != nil {
						targetIP, err = utils.NetMap(ip, o.DstFloater.CIDRsMap)
					} else {
						targetIP = ip
					}
					if err != nil {
...
func (o *CommandMultiCheckOptions) RunNative(iNodeInfos []*FloatInfo, jNodeInfos []*FloatInfo) []*PrintCheckData {
	var resultData []*PrintCheckData
...
func (o *CommandMultiCheckOptions) PrintResult(resultData []*PrintCheckData) {
